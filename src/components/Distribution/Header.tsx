...
const WithdrawPageHeader = ({
  accountVestingBalance,
  accountAvalibleBalance,
    ...
    <div>
      <Row style={{ textAlign: "left" }}>
        ...
        <Col xs={12} md={12}>
          {
            <BalanceBlock
              asset={t("Your total Cook from early investment")}
              balance={accountVestingBalance}
              suffix={" Cook"}
            />
          }
        </Col>
        <Col xs={12} md={6} xl={6}>
          {
            <BalanceBlock
              asset="Claimed/Zapped"
              balance={accountVestedBalance.minus(accountAvalibleBalance)}
              suffix={" Cook"}
            />
          }
        </Col>
        <Col xs={12} md={6} xl={6}>
          {
            <BalanceBlock
              asset="Available to Claim/Zap"
              balance={accountAvalibleBalance}
              suffix={" Cook"}
            />
          }
        </Col>
