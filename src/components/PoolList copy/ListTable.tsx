  ...
  const renderCell = (title, value, size = 16) => {
    return (
      <div>
        ...
        <div style={{ fontSize: 10, color: colors.grey }}>{title}</div>
      </div>
    )
  }
              ...
              <Row align="center">
                <Col xs={rowDisplay[0]} md={rowDisplay[1]}>
                  <Row style={{ padding: 0 }} align="center">
                    ...
                    <span style={{ paddingLeft: 6, color: colors.grey, fontSize: 12 }}>APY <LinearText text={"180%"} size={"16px"} /></span>
                  </Row>
