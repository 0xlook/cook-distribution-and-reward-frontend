    ...
    <div>
      ...
      <Modal visible={opened} onClose={() => setOpened(false)}>
        <div style={{ padding: 20 }}>
          ...
          <Row>
            <Col xs={12}>
              <BalanceBlock asset="Locked" balance={locked} suffix={"Cook"} type={"row"} />
            </Col>
            <Col xs={12}>
              <BalanceBlock asset="Available" balance={unstakable} suffix={"Cook"} type={"row"} />
            </Col>
            <Col xs={12}>
              <BigNumberInput
                adornment="Cook"
            ...
            <Col xs={6}>
              <ActionButton
                ...
                onClick={() => {
                  unstake(
                    poolAddress,
                    toBaseUnitBN(unstakeAmount, COOK.decimals),
                    (hash) => {
